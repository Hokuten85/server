...
xi.job_utils.monk.useDodge = function(player, target, ability)
    ...
    player:addStatusEffect(xi.effect.DODGE, { power = jpLevel + dodgeMod, duration = 180, origin = player })
...
xi.job_utils.monk.useFootwork = function(player, target, ability)
    ...
    player:addStatusEffect(xi.effect.FOOTWORK, { power = kickDmg, duration = 180, origin = player, subPower = kickAttPercent })
