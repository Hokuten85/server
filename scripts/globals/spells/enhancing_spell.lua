...
-- Structure:            [spellId] = { Tier, Main_Effect, Spell_Level, Base_Power, Base_Duration, Composure, Always_Overwrite, Tick_Seconds },
    ...
    -- Haste
    [xi.magic.spell.HASTE        ]    = { 5, xi.effect.HASTE,         40, 1465,  300, true,  false, 0 },
    [xi.magic.spell.HASTE_II     ]    = { 6, xi.effect.HASTE,         96, 2998,  300, true,  false, 0 },
    [xi.magic.spell.HASTEGA      ]    = { 5, xi.effect.HASTE,         48, 1494,  300, false, false, 0 },
    ...
    [xi.magic.spell.DREAD_SPIKES ] = { 1, xi.effect.DREAD_SPIKES,   1,    0,  300, true,  false, 0 },
