...
zones[xi.zone.DYNAMIS_XARCABARD] =
{
    text =
    {
        ...
        DYNAMIS_TIME_EXTEND           = 7237, -- our stay in Dynamis has been extended by <number> minute[/s].
        DYNAMIS_TIME_UPDATE_1         = 7238, -- ou will be expelled from Dynamis in <number> [second/minute] (Earth time).
        DYNAMIS_TIME_UPDATE_2         = 7239, -- ou will be expelled from Dynamis in <number> [seconds/minutes] (Earth time).
        ...
        PRISON_OF_SOULS_HAS_SET_FREE  = 7832, -- e prison of souls has set free its captive spirits!
    },
    mob =
    {
        TIME_EXTENSION =
