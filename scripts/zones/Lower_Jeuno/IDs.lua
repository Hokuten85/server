...
zones[xi.zone.LOWER_JEUNO] =
{
    text =
    {
        ...
        PARIKE_PORANKE_6              = 8994,  -- 's digestive magic skill rises 0.1 points.
        PARIKE_PORANKE_7              = 8995,  -- 's digestive magic skill rises one level.
        ...
        PARIKE_PORANKE_13             = 9006,  -- 's all in the name of science skill rises 0.1 points.
        PARIKE_PORANKE_14             = 9007,  -- 's all in the name of science skill rises one level.
