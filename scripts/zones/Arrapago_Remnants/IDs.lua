...
zones[xi.zone.ARRAPAGO_REMNANTS] =
{
    text =
    {
        ...
        TIME_REMAINING_MINUTES        = 7465, -- ime remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS        = 7466, -- ime remaining: <number> [second/seconds] (Earth time).
        PARTY_FALLEN                  = 7468, -- ll party members have fallen in battle. Mission failure in <number> [minute/minutes].
