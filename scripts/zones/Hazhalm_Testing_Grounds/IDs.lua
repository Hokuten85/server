...
zones[xi.zone.HAZHALM_TESTING_GROUNDS] =
{
    text =
    {
        ...
        LAMP_POWER_FADED              = 8069, -- he power of the % has faded. You may no longer occupy this chamber.
        TOO_MANY_ADVENTURERS          = 8071, -- There are too many adventurers in the chamber.
        TIMEOUT_WARNING               = 8072, -- ---== Warning! ==---- Your reservation of this chamber will end in # [minute/minutes].
        TIMEOUT_WARNING_SECONDS       = 8073, -- ---== Warning! ==---- Your reservation of this chamber will end in # [second/seconds].
