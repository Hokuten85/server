...
zones[xi.zone.DYNAMIS_QUFIM] =
{
    text =
    {
        ...
        DYNAMIS_TIME_EXTEND           = 7338, -- our stay in Dynamis has been extended by <number> minute[/s].
        DYNAMIS_TIME_UPDATE_1         = 7339, -- ou will be expelled from Dynamis in <number> [second/minute] (Earth time).
        DYNAMIS_TIME_UPDATE_2         = 7340, -- ou will be expelled from Dynamis in <number> [seconds/minutes] (Earth time).
