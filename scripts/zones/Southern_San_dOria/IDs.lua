...
zones[xi.zone.SOUTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        YOU_OBTAIN_ITEM                = 6443,  -- You obtain  <item>!
        ...
        YOU_HAVE_JOINED_UNITY          = 16094, -- ou have joined [Pieuje's/Ayame's/Invincible Shield's/Apururu's/Maat's/Aldo's/Jakoh Wahcondalo's/Naja Salaheem's/Flaviria's/Yoran-Oran's/Sylvie's] Unity!
        HAVE_ALREADY_CHANGED_UNITY     = 16170, -- ou have already changed Unities. Please wait until the next tabulation period.
