...
zones[xi.zone.NYZUL_ISLE] =
{
    text =
    {
        ...
        TIME_REMAINING_MINUTES        = 7326, -- ime remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS        = 7327, -- ime remaining: <number> [second/seconds] (Earth time).
        FADES_INTO_NOTHINGNESS        = 7328, -- The <keyitem> fades into nothingness...
        PARTY_FALLEN                  = 7329, -- ll party members have fallen in battle. Mission failure in <number> [minute/minutes].
        ...
        OBJECTIVE_COMPLETE            = 7366, -- loor <number> objective complete. Rune of Transfer activated.
