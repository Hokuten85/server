...
private:
    ...
    const timer::duration m_returnWeaponDelay = 100ms; // Phase 2: Putting the weapon back after a shot (time between shot and being able to move)
    const timer::duration m_freePhaseTime     = 1000ms; // Phase 3: The cooldown after a ranged attack is executed. (time after being able to move befer you stop getting "you must wait longer" when attempting to Range Attack again)
